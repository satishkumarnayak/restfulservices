package com.demo.restful.restfulservices.exception;
...
import com.demo.restful.restfulservices.user.UserNotFoundException;


@ControllerAdvice   // To be shared by mutiple controllers
@RestController
